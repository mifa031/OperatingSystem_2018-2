...
//--------------------------------------------------- 
//open BootLoader file and copy all content to Disk img file
//--------------------------------------------------- 
...
//insert 0x00 to remainder sector
	iBootLoaderSize = AdjustInSectorSize(iTargetFd, iSourceSize);
	printf("[INFO] %s size = [%d] and sector count = [%d]\n", argv[1],iSourceSize,iBootLoaderSize);
	

//--------------------------------------------------- 
// open 32bit Kernel file and copy all content to Disk img file
//--------------------------------------------------- 
...
//----------------------------------------------------
// open 64bit Kernel file and copy all content to Disk img file
//----------------------------------------------------
...
//from 5th byte, insert kernel information
